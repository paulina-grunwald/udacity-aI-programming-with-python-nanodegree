...
def calculates_results_stats(results_dic):
    ...
    # Calculates run statistics (counts & percentages) below that are calculated using the counters from above.
    ...
    # Calculates % correct not-a-dog imagesUses conditional statement for when no 'not a dog' images were submitted 
